...
cur.execute("""CREATE TABLE public.tweet(index integer NOT NULL, handle char(20) NOT NULL, text text NOT NULL, original_author char(20),time timestamp NOT NULL, retweet_count integer NOT NULL, favourite_count integer NOT NULL, CONSTRAINT "PK" PRIMARY KEY ("index"))""")
#query zum Erstellen einer Datenbank, durch den Cursor ausgefuehrt
cur.execute("""COPY tweet FROM '/home/traplord/Schreibtisch/cleanelection.csv' DELIMITER ',' CSV HEADER""")
